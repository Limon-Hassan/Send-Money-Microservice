      ...
      <div className="currency-calculator-area ptb-120 bg-f7f7f7">
        <div className="container">
          <h2 className="main-title style-two text-center mb-40 mw-1208 mx-auto">
            Streamlining global payments for businesses
          </h2>
            ...
            <div className="col-lg-5">
              {/* <form className="currency-converter-form style-two bg-primary">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h3 className="mb-0 text-secondary">Fast Transfers</h3>
                </div>
                ...
                <p className="text-secondary">
                  Exchange rate: {formData.sendAmount}{" "}
                  {formData.fromCurrency.code} = {formData.exchangeRate}{" "}
                  {formData.toCurrency.code} (No hidden fees)
                </p>
