...
export const countriesData: CountryRecord[] = [
  {
    code: 'USD',
...
export const countriesTotalCount = countriesData.length;

// ---------- Lookup helpers ----------

export const countryByCode = (code: string): CountryRecord | undefined =>
  countriesData.find(c => c.code.toLowerCase() === code.toLowerCase());

export const countryByName = (name: string): CountryRecord | undefined =>
  countriesData.find(c => c.name.toLowerCase() === name.toLowerCase());

export const flagForCountry = (name: string): string =>
  countryByName(name)?.flag ?? '🏳️';


export const countryNameOptions: string[] = countriesData.map(c => c.name);
export const countryNameOptionsWithAll: string[] = [
  'All Countries',
  ...countryNameOptions,
];

export const countryByCountryName = (
  countryName: string,
...
export const flagForCountryName = (countryName: string): string =>
  countryByCountryName(countryName)?.flag ?? '/images/flags/_default.svg';

export const countryCodeOptions: string[] = countriesData.map(c => c.code);
export const countryCodeOptionsWithAll: string[] = [
  'All Countries',
  ...countryCodeOptions,
];
