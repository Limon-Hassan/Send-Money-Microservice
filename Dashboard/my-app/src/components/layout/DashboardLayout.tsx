...
export default function DashboardLayout() {
  ...
  const sidebarWidth = collapsed ? "72px" : "300px";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        className="flex flex-col min-h-screen transition-all duration-350"
        style={{
          marginLeft: window && typeof window !== "undefined" && window.innerWidth >= 768 ? sidebarWidth : 0,
        ...
        <footer className="text-center py-4 text-xs text-gray-400 border-t border-gray-100 bg-white">
          <div className="flex items-center justify-center gap-2">
            <div className="w-5 h-5 rounded bg-[#0a2012] flex items-center justify-center">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#7ffe4a" strokeWidth="2.5">
